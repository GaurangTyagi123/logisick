![alt text](frontend/public/logo64.png)<div style="display:flex;aligh-items:baseline;gap:1rem;">LogiSick – Smart inventory and logistics management, all in one place.</div>
