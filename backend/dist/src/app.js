...
if (process.env.NODE_ENV === 'production') {
    ...
    app.options('{*splat}', (0, cors_1.default)({ origin: 'http://localhost:5173', credentials: true }));
}
app.get('/api/v1/csrf-token', auth_middleware_1.csrfProtection, (req, res, _next) => {
